...
def main() -> int:
    ...
    # El respaldo va ANTES de migrar, no despues. Estaba al reves, y el efecto
    # era que la copia de un dia con migracion guardaba la base ya migrada: si
    # algo salia mal no habia a donde volver.
