...
class RotaryDialog(GuardedDialog):
    def __init__(
        self,
        ...
        # Igual que en Fatiga: al final, midiendo con los datos ya cargados.
    ...
    def _build(self) -> None:
        ...
        # Pedia 850 px de alto: en un portatil los botones quedaban fuera de la
        # pantalla. Se desplazan los datos; el titulo y los botones no.
