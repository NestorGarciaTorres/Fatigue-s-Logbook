...
class RotaryPage(BasePage):
    def __init__(self, context: AppContext, parent=None):
        super().__init__("Bitácora de Rotary", parent)
        ...
        # Lo que dejen los filtros, igual que en Fatiga.
        ...
        # En su propia fila, por lo mismo que en Fatiga: junto a los botones
        # la fila no cabia en un portatil.
        cards = QHBoxLayout()
        cards.addStretch(1)
    ...
    def export(self) -> None:
        ...
        save_report(
            self, len(records), suggested_filename("Rotary"),
            lambda path: export_rotary(records, colores, path, period=periodo),
        )
