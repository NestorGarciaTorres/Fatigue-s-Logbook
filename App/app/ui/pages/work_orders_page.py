...
class WorkOrdersPage(BasePage):
    ...
    def __init__(self, context: AppContext, parent=None):
        ...
        # En la fila del filtro y no con los botones de arriba: exporta lo que
        # ese filtro deja, y la fila de arriba ya va justa en un portatil.
        ...
        self.export_button.setToolTip("Las órdenes que se ven, en su orden (Ctrl+E)")
    ...
    def export(self) -> None:
        ...
        save_report(
            ...
            lambda path: export_work_orders(ordenes, path, TYPE_LABELS),
