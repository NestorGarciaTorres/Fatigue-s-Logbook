...
# ======================================================================
print("\n=== 2. Combo de pieza: rigs + los 3 estatus ===")
...
print(f"     {items}")
check("incluye todos los rigs de fatiga",
      all(r in items for r in rig_names), str(rig_names))
check("incluye los 3 estatus", all(s in items for s in statuses), str(statuses))
check("lleva separador entre ambos grupos", "" in items)
check("no es editable", not combo.isEditable())
