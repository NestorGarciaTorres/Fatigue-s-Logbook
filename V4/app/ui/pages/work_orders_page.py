...
class WorkOrdersPage(BasePage):
    ...
    def __init__(self, context: AppContext, parent=None):
        ...
        hint = QLabel(
            ...
            "órdenes de Torsión y Quasi se registran igual, pero esas "
            "bitácoras siguen dando de alta sus pruebas por su cuenta."
        )
    ...
    def _action(self, order: WorkOrder):
        ...
        if order.test_type not in STARTABLE_TEST_TYPES:
            ...
            return self._note(
                "  alta en su bitácora  ",
                f"{label} todavía no se comienza desde aquí: da de alta la "
                f"prueba en la bitácora de {label}.",
            )
